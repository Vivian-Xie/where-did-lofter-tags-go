...
# ── 配置 ──────────────────────────────────────────────────────────────────────
TAG_URL    = "https://www.lofter.com/tag/%E5%A4%AA%E4%B8%AD/new"
TAG_NAME   = "%E5%A4%AA%E4%B8%AD"
DWR_URL    = "http://www.lofter.com/dwr/call/plaincall/TagBean.search.dwr"
DATA_FILE  = "data/taizhong_records.json"
...
def run():
    ...
    # 与基准的差值
    _bc = (data.get("baseline") or {}).get("count")
    baseline_delta = (official_count - _bc) if (official_count is not None and _bc is not None) else None
